...
import { ITableList, IHealthParameterUnit, IDropdownItem, IResponse } from '@eatfit247-shared-lib';
...
export class HealthParameterUnitController {
  ...
  @Get('manage/:id')
  async getById(@Param('id') id: number): Promise<IResponse<IHealthParameterUnit>> {
