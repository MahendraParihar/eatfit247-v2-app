...
@Table({
  ...
  modelName: 'mst_sleeping_patterns',
  schema: 'public',
  tableName: 'mst_sleeping_patterns',
})
@Scopes(() => ({
  list: CommonScopes.list(),
  details: CommonScopes.details(),
}))
export class MstSleepingPattern extends Model<MstSleepingPattern> {
  @Column({
  ...
  @Column({
    allowNull: false,
    field: 'sleeping_pattern',
    type: DataType.STRING(50),
  })
  declare sleepingPattern: string;
