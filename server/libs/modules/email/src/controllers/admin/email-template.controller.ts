...
import { CreateEmailTemplateDto, SendEmailDto } from '../../dto';
import { ITableList, IEmailTemplate } from 'eatfit247-shared-lib';
...
export class EmailTemplateController {
  ...
  @Post('send-email')
  async sendEmail(@Body() body: SendEmailDto): Promise<void> {
    await this.service.sendEmail(body);
  }
}
