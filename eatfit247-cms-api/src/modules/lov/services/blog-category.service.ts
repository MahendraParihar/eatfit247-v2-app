...
export class BlogCategoryService {
  ...
  public async getBlogCategoryList(): Promise<IDropdownItem[]> {
  ...
  private async createInDB(obj: any) {
    return await this.blogCategoryRepository.create(obj);
  }

  private async updateInDB(id: number, obj: any) {
    return await this.blogCategoryRepository.update(obj, { where: { blogCategoryId: id } });
  }
}
