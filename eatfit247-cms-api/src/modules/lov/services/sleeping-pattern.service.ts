...
export class SleepingPatternService {
  ...
  public async getSleepingPatternList(): Promise<DropdownListInterface[]> {
  ...
  private async createInDB(obj: any) {
    return await this.sleepingPatternRepository
      .create(obj)
      .then((result) => {
        return result;
      })
  ...
  private async updateInDB(id: number, obj: any) {
    return await this.sleepingPatternRepository
      .update(obj, { where: { sleepingPatternId: id } })
      .then((result) => {
        return result;
      })
      .catch((e) => {
