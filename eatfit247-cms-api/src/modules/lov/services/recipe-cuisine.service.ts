...
export class RecipeCuisineService {
  ...
  public async getRecipeCuisineList(): Promise<DropdownListInterface[]> {
  ...
  private async createInDB(obj: any) {
    return await this.recipeCuisineRepository
      .create(obj)
      .then((result) => {
        return result;
      })
  ...
  private async updateInDB(id: number, obj: any) {
    return await this.recipeCuisineRepository
      .update(obj, { where: { recipeCuisineId: id } })
      .then((result) => {
        return result;
      })
      .catch((e) => {
