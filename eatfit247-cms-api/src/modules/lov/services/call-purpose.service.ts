...
export class CallPurposeService {
  ...
  public async findAll(searchDto: BasicSearchDto): Promise<IServerResponse> {
    ...
    try {
      ...
      const { rows, count } = await this.callPurposeRepository.findAndCountAll<MstCallPurpose>({
        include: [
          {
            model: MstAdminUser,
            required: false,
  ...
  public async fetchById(id: number): Promise<IServerResponse> {
    ...
    try {
      ...
      if (find) {
        const dataObj = <ILov>{
          id: find.callPurposeId,
          name: find.callPurpose,
          active: find.active,
  ...
  public async getCallPurposeList(): Promise<DropdownListInterface[]> {
  ...
  private async createInDB(obj: any) {
    return await this.callPurposeRepository
      .create(obj)
      .then((result) => {
        return result;
      })
  ...
  private async updateInDB(id: number, obj: any) {
    return await this.callPurposeRepository
      .update(obj, { where: { callPurposeId: id } })
      .then((result) => {
        return result;
      })
      .catch((e) => {
