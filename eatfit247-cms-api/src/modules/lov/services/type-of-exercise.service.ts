...
export class TypeOfExerciseService {
  ...
  public async getTypeOfExerciseList(): Promise<DropdownListInterface[]> {
  ...
  private async createInDB(obj: any) {
    return await this.typeOfExerciseRepository
      .create(obj)
      .then((result) => {
        return result;
      })
  ...
  private async updateInDB(id: number, obj: any) {
    return await this.typeOfExerciseRepository
      .update(obj, { where: { typeOfExerciseId: id } })
      .then((result) => {
        return result;
      })
      .catch((e) => {
