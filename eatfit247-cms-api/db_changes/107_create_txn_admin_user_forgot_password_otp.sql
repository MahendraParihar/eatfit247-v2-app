...
create type public.banner_for as enum ('home', 'about_us', 'program', 'product', 'quiz', 'media_press', 'success_stories', 'blogs', 'contact_us', 'about_shweta','our_program','quiz_dosha','quiz_immunity');
