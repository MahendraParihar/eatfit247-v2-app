      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build eatfit247-admin
<span># Test</span>
nx test eatfit247-admin
<span># Lint</span>
nx lint eatfit247-admin
<span># Run them together!</span>
nx run-many -p eatfit247-admin -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project eatfit247-admin</pre>
          </details>
