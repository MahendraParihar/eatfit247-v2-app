...
export class Faq implements OnInit {
  ...
  totalCount = 0;
  loading = false;
  tableConfig!: TableConfig<IFaq>;
  private searchSubject = new Subject<string>();

  constructor(private apiService: FaqApiService) {
    this.setupSearch();
  }
  ...
  private initializeTable(): void {
    const columns: TableColumn<IFaq>[] = [
    ...
    const actions: TableAction<IFaq>[] = [
