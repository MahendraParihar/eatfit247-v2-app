...
export class Members implements OnInit, AfterViewInit, OnDestroy {
  ...
  private initializeTable(): void {
    const columns: ITableColumn<IMember>[] = [
      ...
      { key: 'country', label: 'Country', dataKey: 'country', sortField: 'country', sortable: true, formatter: (value) => value || '-' },
      { key: 'franchise', label: 'Franchise', dataKey: 'franchise', sortField: 'franchise', sortable: true, formatter: (value) => value || '-' },
