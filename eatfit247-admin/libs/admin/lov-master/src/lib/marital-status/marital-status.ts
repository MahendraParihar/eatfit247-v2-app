...
export class MaritalStatus implements OnInit {
  ...
  totalCount = 0;
  loading = false;
  tableConfig!: TableConfig<IMaritalStatus>;
  ...
  private initializeTable(): void {
    const columns: TableColumn<IMaritalStatus>[] = [
    ...
    const actions: TableAction<IMaritalStatus>[] = [
  ...
  editItem(item: IMaritalStatus): void {
    console.log('Edit marital status:', item);
  }
