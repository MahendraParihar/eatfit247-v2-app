...
export class HealthIssue implements OnInit {
  ...
  private initializeTable(): void {
    const columns: ITableColumn<IHealthIssue>[] = [
    ...
    const actions: ITableAction<IHealthIssue>[] = [
  ...
  editItem(item: IHealthIssue): void {
    this.router.navigate(['/lov-master/health-issue/edit', item.healthIssueId]);
  }

  createItem(): void {
    this.router.navigate(['/lov-master/health-issue/new']);
  }
