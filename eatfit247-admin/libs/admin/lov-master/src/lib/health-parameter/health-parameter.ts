...
export class HealthParameter implements OnInit {
  ...
  totalCount = 0;
  loading = false;
  tableConfig!: TableConfig<IHealthParameter>;
  ...
  private initializeTable(): void {
    const columns: TableColumn<IHealthParameter>[] = [
    ...
    const actions: TableAction<IHealthParameter>[] = [
  ...
  editItem(item: IHealthParameter): void {
    console.log('Edit health parameter:', item);
  }
