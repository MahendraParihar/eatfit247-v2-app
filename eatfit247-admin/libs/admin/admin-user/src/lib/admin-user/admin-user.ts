...
export class AdminUser implements OnInit {
  ...
  totalCount = 0;
  loading = false;
  tableConfig!: TableConfig<IAdminUser>;
  private searchSubject = new Subject<string>();

  constructor(private apiService: AdminUserApiService) {
    this.setupSearch();
  }
  ...
  private initializeTable(): void {
    const columns: TableColumn<IAdminUser>[] = [
    ...
    const actions: TableAction<IAdminUser>[] = [
