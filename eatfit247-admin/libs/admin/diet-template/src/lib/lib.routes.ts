...
import { DietTemplateBuilderComponent } from './builder/diet-template-builder.component';

export const dietTemplateRoutes: Route[] = [
  { path: '', component: DietTemplateComponent, title: 'Diet Templates' },
  { path: 'builder/:dietTemplateId', component: DietTemplateBuilderComponent, title: 'Manage Diet Template' },
