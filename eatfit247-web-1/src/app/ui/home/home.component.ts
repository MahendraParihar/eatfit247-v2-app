  ...
  readonly credentials: Credential[] = [
    {
      icon: 'school',
      title: 'Postgraduate ',
      subtitle: 'Dietetics and Applied Nutrition',
    },
    {
      icon: 'workspace_premium',
      title: 'Awards',
      subtitle: 'felicitated by awards like Bharat Ke Anmol & Dainik Jagran Award',
    },
    {
      icon: 'groups',
      title: '12,000+ clients',
      subtitle: '5200+ successful Client Stories across 62 countries',
    },
  ];
  ...
  readonly fallbackTestimonials: TestimonialStory[] = [
    {
      ...
      quote:
        "I'd tried every fad diet out there. Shweta's plan finally felt like something I could do forever — and the weight just kept coming off.",
    ...
    },
    {
      ...
      quote:
        'My cycles are regular for the first time in six years. The fact that the plan respects Gujarati food culture made it so much easier to stick to.',
    },
    {
      name: 'Vikram D.',
      image:
      ...
      quote:
        'I expected a diet. I got a lifestyle rewire. Sleep, stress, meals — everything clicks together now. Best investment I have made in myself.',
    ...
    },
    {
      ...
      quote:
        'Six months in and my reports look like a different person. Practical food, no punishing rules — my family eats the same meals.',
    ...
    },
    {
      ...
      quote:
        'I dropped 12kg in 5 months and — most importantly — it stayed off. The check-ins kept me honest without being a chore.',
