...
SELECT SETVAL('mst_address_types_address_type_id_seq', (SELECT MAX(address_type_id) + 1 FROM mst_address_types));
SELECT SETVAL('mst_admin_role_permissions_admin_role_permission_id_seq', (SELECT MAX(admin_role_permission_id) + 1 FROM mst_admin_role_permissions));
...
SELECT SETVAL('mst_blood_sugars_blood_sugar_id_seq', (SELECT MAX(blood_sugar_id) + 1 FROM mst_blood_sugars));
SELECT SETVAL('mst_call_log_statuses_call_log_status_id_seq', (SELECT MAX(call_log_status_id) + 1 FROM mst_call_log_statuses));
SELECT SETVAL('mst_call_purposes_call_purpose_id_seq', (SELECT MAX(call_purpose_id) + 1 FROM mst_call_purposes));
SELECT SETVAL('mst_call_types_call_type_id_seq', (SELECT MAX(call_type_id) + 1 FROM mst_call_types));
...
SELECT SETVAL('mst_currency_configs_currency_config_id_seq', (SELECT MAX(currency_config_id) + 1 FROM mst_currency_configs));
SELECT SETVAL('mst_eating_habits_eating_habit_id_seq', (SELECT MAX(eating_habit_id) + 1 FROM mst_eating_habits));
...
SELECT SETVAL('mst_genders_gender_id_seq', (SELECT MAX(gender_id) + 1 FROM mst_genders));
...
SELECT SETVAL('mst_lifestyles_lifestyle_id_seq', (SELECT MAX(lifestyle_id) + 1 FROM mst_lifestyles));
SELECT SETVAL('mst_marital_statuses_marital_status_id_seq', (SELECT MAX(marital_status_id) + 1 FROM mst_marital_statuses));
...
SELECT SETVAL('mst_payment_statuses_payment_status_id_seq', (SELECT MAX(payment_status_id) + 1 FROM mst_payment_statuses));
SELECT SETVAL('mst_plan_status_plan_status_id_seq', (SELECT MAX(plan_status_id) + 1 FROM mst_plan_status));
SELECT SETVAL('mst_pocket_guides_pocket_guide_id_seq', (SELECT MAX(pocket_guide_id) + 1 FROM mst_pocket_guides));
...
SELECT SETVAL('mst_program_plan_types_program_plan_type_id_seq', (SELECT MAX(program_plan_type_id) + 1 FROM mst_program_plan_types));
...
SELECT SETVAL('mst_referrers_referrer_id_seq', (SELECT MAX(referrer_id) + 1 FROM mst_referrers));
SELECT SETVAL('mst_religions_religion_id_seq', (SELECT MAX(religion_id) + 1 FROM mst_religions));
SELECT SETVAL('mst_sleeping_patterns_sleeping_pattern_id_seq', (SELECT MAX(sleeping_pattern_id) + 1 FROM mst_sleeping_patterns));
...
SELECT SETVAL('mst_type_of_exercises_type_of_exercise_id_seq', (SELECT MAX(type_of_exercise_id) + 1 FROM mst_type_of_exercises));
SELECT SETVAL('mst_urine_outputs_urine_output_id_seq', (SELECT MAX(urine_output_id) + 1 FROM mst_urine_outputs));
...
SELECT SETVAL('txn_member_diet_details_member_diet_detail_id_seq', (SELECT MAX(member_diet_detail_id) + 1 FROM txn_member_diet_details));
