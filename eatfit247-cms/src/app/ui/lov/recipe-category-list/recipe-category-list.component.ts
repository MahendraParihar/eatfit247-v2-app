...
export class RecipeCategoryListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private fb: FormBuilder,
    ...
    this.dataSource = new RecipeCategoryDatasource(this.httpService, this.snackBarService);
  ...
  async updateStatusTask(item: LovModel, index: number): Promise<void> {
    ...
    const res: ResponseDataModel = await this.httpService.patchRequest(ApiUrlEnum.RECIPE_CATEGORY_STATUS_CHANGE, item.id, payload, true);
    if (res) {
      switch (res.code) {
