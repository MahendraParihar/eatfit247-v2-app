...
export class FaqCategoryListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  async loadDataSet(): Promise<void> {
    ...
    await this.dataSource.loadData(ApiUrlEnum.FAQ_CATEGORY_LIST, this.payload);
  }
  ...
  async updateStatusTask(item: LovModel, index: number): Promise<void> {
    ...
    const res: ResponseDataModel = await this.httpService.patchRequest(ApiUrlEnum.FAQ_CATEGORY_STATUS_CHANGE, item.id, payload, true);
    if (res) {
      switch (res.code) {
