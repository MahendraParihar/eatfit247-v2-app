...
export class MemberPaymentManageDialogComponent implements OnInit {
  ...
  formGroup: FormGroup = this.fb.group({
    ...
    userOrderAmount: [null, [Validators.required, ValidationUtil.numberValidation, Validators.min(0)]],
    userDiscountAmount: [null, [ValidationUtil.numberValidation, Validators.min(0)]],
    userTaxAmount: [null, [Validators.required, ValidationUtil.numberValidation, Validators.min(0)]],
    userTotalAmount: [null, [Validators.required, ValidationUtil.numberValidation, Validators.min(0)]],
    systemOrderAmount: [null, [Validators.required, ValidationUtil.numberValidation, Validators.min(0)]],
    systemDiscountAmount: [null, [ValidationUtil.numberValidation, Validators.min(0)]],
    systemTaxAmount: [null, [Validators.required, ValidationUtil.numberValidation, Validators.min(0)]],
    systemTotalAmount: [null, [Validators.required, ValidationUtil.numberValidation, Validators.min(0)]],
