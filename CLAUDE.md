...
Each project has its own CLAUDE.md with detailed build commands, architecture, and conventions:

- [server_1/CLAUDE.md](server_1/CLAUDE.md) — NestJS backend API (admin-api :3001 + public-api :3000)
- [eatfit247-admin/CLAUDE.md](eatfit247-admin/CLAUDE.md) — Angular 20 admin CMS
- [eatfit247-web-1/CLAUDE.md](eatfit247-web-1/CLAUDE.md) — Angular 21 public website with SSR
- [infra/CLAUDE.md](infra/CLAUDE.md) — Docker, Nginx, deployment infrastructure
